                ...
                >
                    {({ isActive }) => (
                        <div className={`flex items-center space-x-3 p-3 rounded-xl shadow-sm border transition-all duration-200 ${isActive
                            ? "bg-gradient-to-r from-indigo-500 to-blue-600 border-indigo-500 shadow-lg shadow-indigo-500/25"
                            ...
                            <div className="flex-1 min-w-0">
                                <p className={`text-sm font-medium truncate transition-colors duration-200 ${isActive ? "text-white" : "text-gray-900"
                                    }`}>
                                    {user?.name || 'Admin User'}
                                </p>
                                <p className={`text-xs truncate transition-colors duration-200 ${isActive ? "text-white/80" : "text-gray-500"
                                    }`}>
